// src/dashboard/ProjectList.jsx - Example of how to update your component
...
function ProjectList() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      // Use the apiClient which automatically handles token refresh
        ...
        {projects.length === 0 ? (
          ...
          projects.map(project => (
            ...
            >
              ...
              <button
                onClick={() => window.location.href = `/board/${project.id}`}
                style={{
                  padding: '6px 12px',
